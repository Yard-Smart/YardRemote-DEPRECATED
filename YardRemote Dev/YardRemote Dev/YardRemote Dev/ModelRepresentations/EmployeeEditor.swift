    ...
    var body: some View {
        ZStack{
            ...
            VStack{
                RoundedRectangle(cornerRadius: 10, style: .circular)
                    .fill(Color(UIColor.secondarySystemFill))
                    .overlay(TextField("", text: $employee.name)
                ...
                ZStack{
                    RoundedRectangle(cornerRadius: 10, style: .circular)
                        .fill(Color(UIColor.tertiarySystemFill))
                    TextField("Position", text: $employee.messages[0].title)
                }
                Spacer()
                ...
                HStack{
                    ZStack{
                        ...
                        HStack {
                            Text("CreatorID:")
                            TextField("", text: $employee.creatorID)
                        }
                    }
                    ZStack{
                        RoundedRectangle(cornerRadius: 10, style: .circular)
                        ...
                        HStack {
                            Text("ImageID:")
                            TextField("", text: $employee.imageID)
                        }
                    }
                }
                ...
                ZStack{
                    ...
                    HStack {
                        Text("Created:")
                        TextField("", text: $employee.messages[0].timeSent)
                    }
                }
                ZStack{
                    RoundedRectangle(cornerRadius: 10, style: .circular)
                    ...
                    HStack {
                        Text("Balance:")
                        TextField("", text: $employee.balance)
                    }
                }
            }
            .padding(10)
    ...
    var body: some View {
        LazyVStack{
            ...
            ForEach(0 ..< employees.count,id: \.self){num in
                NavigationLink(destination: EmployeeEditor(employee: $employees[num])) {
